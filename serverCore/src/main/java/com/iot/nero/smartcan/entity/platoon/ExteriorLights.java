...
public enum ExteriorLights {
	...
	public static ExteriorLights valueOf(int value){
		ExteriorLights[] values = values();
	...
	private ExteriorLights(int value) {
		this.value = value;
	}
	...
	static {
		CONV = new ReflectionEnumeratedConverter(ExteriorLights.class);
	}

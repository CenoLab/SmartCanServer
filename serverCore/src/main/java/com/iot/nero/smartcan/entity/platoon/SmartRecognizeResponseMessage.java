...
public class SmartRecognizeResponseMessage {
	...
	public boolean equals(Object obj) {
		if(!(obj instanceof SmartRecognizeResponseMessage)){
			return false;
		}
	...
	public static SmartRecognizeResponseMessage ber_decode(InputStream in) throws IOException {
		return (SmartRecognizeResponseMessage)TYPE.decode(in, EncodingRules.BASIC_ENCODING_RULES, CONV);
	}
	...
	static {
		CONV = new AnnotationCompositeConverter(SmartRecognizeResponseMessage.class);

...
public class SmartCanResponseMessage {
	...
	public boolean equals(Object obj) {
		if(!(obj instanceof SmartCanResponseMessage)){
			return false;
		}
	...
	public static SmartCanResponseMessage ber_decode(InputStream in) throws IOException {
		return (SmartCanResponseMessage)TYPE.decode(in, EncodingRules.BASIC_ENCODING_RULES, CONV);
	}
	...
	static {
		CONV = new AnnotationCompositeConverter(SmartCanResponseMessage.class);

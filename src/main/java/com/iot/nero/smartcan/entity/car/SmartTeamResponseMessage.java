...
public class SmartTeamResponseMessage {
	...
	public boolean equals(Object obj) {
		if(!(obj instanceof SmartTeamResponseMessage)){
			return false;
		}
	...
	public static SmartTeamResponseMessage ber_decode(InputStream in) throws IOException {
		return (SmartTeamResponseMessage)TYPE.decode(in, EncodingRules.BASIC_ENCODING_RULES, CONV);
	}


	public final static AsnType TYPE = Platoon.type(65628);

	public final static CompositeConverter CONV;

	static {
		CONV = new AnnotationCompositeConverter(SmartTeamResponseMessage.class);
